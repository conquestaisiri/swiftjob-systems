...
| GitHub | VERIFIED for repository and hosted CI: `gh` is authenticated as the repository owner, PR #1 is open, and hosted CI run `34681345770` passes typecheck, isolated regressions and the frontend build. GitHub Actions production deployment jobs remain skipped on pull requests; repository secret values were not read. |
