...
| Resend | PARTIALLY VERIFIED: the stored live key reads the Resend account and reports `payservice.top` verified with DKIM/SPF records verified. A designated recipient mailbox, real receipt, bounce/suppression state and provider event evidence remain NOT VERIFIED. |
